...
def predict_dp(self):
    ...
    if global_config.test_displacement_scale:
        self.dp_map_scale = global_config.dis_scale
    self.dp_map = F.tanh(self.dp_tensor) * self.dp_map_scale
    self.deformation_map = F.tanh(self.deformation_para) * global_config.deformation_scale
...
def update_shape(self):
    ...
    elif self.stage == 'deformation map':
        self.pred_vertex, self.pred_vertex_norm = \
