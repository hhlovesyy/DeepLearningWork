...
def parse_args():
    ...
    parser.add_argument("--stage",type=str,default='coarse geometry generation',choices=['coarse geometry generation', 'texture generation','edit', 'deformation map', 'displacement map'])
