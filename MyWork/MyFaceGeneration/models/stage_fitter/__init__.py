...
class StageFitter(object):
    def __init__(self, SD_guidance,
        ...
        self.facemodel = HIFIParametricFaceModel(
                hifi_folder='/sys/fs/cgroup/HIFI3D/files', camera_distance=self.camera_d, focal=self.focal, center=center,
                is_train=True, 
                opt_id_dim = 526,
                opt_exp_dim = 203,
                opt_tex_dim = 80,
    ...
    def define_optim_param(self):
        ...
        if self.stage == 'coarse geometry generation':
            ...
            if global_settings.test_dis_map:
                self.optim_param.append(self.dp_tensor)
